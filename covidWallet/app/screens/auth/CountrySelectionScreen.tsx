...
const CountrySelectionScreen = (props: INProps) => {
  // Constants
  ...
  const handleSubmit = () => {
    dispatch(updateUser({ ...user, country: selectedValue }));
      ...
      <View style={styles.container}>
        <View style={styles.container}>
          <View style={styles.logoContainer}>
            ...
            <Text style={styles.subHeadingText}>Please select your country</Text>
          </View>
